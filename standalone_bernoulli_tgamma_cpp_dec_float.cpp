...
namespace example008_bernoulli_cpp_dec_float
{
  ...
  auto tgamma(const FloatingPointType& x) -> FloatingPointType
  {
    ...
    using example008_bernoulli_cpp_dec_float::pi;
    using std::exp;
...
} // namespace example008_bernoulli_dec_bin_float

auto example008_bernoulli_tgamma_cpp_dec_float() -> bool
{
  using namespace example008_bernoulli_cpp_dec_float;
