...
namespace example008_bernoulli_mpfr_float
{
  using wide_float_backend_type = boost::multiprecision::mpfr_float_backend<my_digits10>;
  ...
  auto tgamma(const FloatingPointType& x) -> FloatingPointType
  {
    ...
    using example008_bernoulli_mpfr_float::pi;
    using std::exp;
...
auto example008_bernoulli_tgamma_mpfr_float() -> bool
{
  using namespace example008_bernoulli_mpfr_float;
