...
namespace example008_bernoulli_cpp_bin_float
{
  using wide_float_backend_type = boost::multiprecision::cpp_bin_float<my_digits10, boost::multiprecision::digit_base_10, std::allocator<void>>;
  ...
  auto tgamma(const FloatingPointType& x) -> FloatingPointType
  {
    ...
    using example008_bernoulli_cpp_bin_float::pi;
    using std::exp;
...
auto example008_bernoulli_tgamma_cpp_bin_float() -> bool
{
  using namespace example008_bernoulli_cpp_bin_float;
